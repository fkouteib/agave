...
const NUM_TSS_WORKER_THREADS: usize = 24;
                ...
                loop {
                    ...
                    worker_thread_pool.install(|| {
                        rayon::scope(|s| {
                            ...
                            let slot_completion_callback = Arc::clone(&slot_completion_callback);
                            let slot_tracker = Arc::clone(&slot_tracker);
