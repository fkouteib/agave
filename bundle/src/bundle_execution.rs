...
pub fn load_and_execute_bundle<'a, 'b>(
    ...
    while chunk_start != txns.len() {
        ...
        out_timestamps[3 * chunk_start + 0] = metrics.execute_timings.details.ts_tx_start;
        out_timestamps[3 * chunk_start + 1] = metrics.execute_timings.details.ts_tx_load_end;
        out_timestamps[3 * chunk_start + 2] = metrics.execute_timings.details.ts_tx_end;
